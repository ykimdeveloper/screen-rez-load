...
import BrowserDemo from "../demo/browser/browserdevice";
import DivWithSize from "../components/DivWithSize_";
import { useMediaQuery, useTheme } from "@mui/material";

import useBrowserJsInfo from "../hooks/useBrowserJsInfo";

import MyMap from '../components/map'
import BrowserWarning from '../components/browserWarning'

export default function BrowserJSView() {
  ...
  const isDesktop = useMediaQuery(theme.breakpoints.up("md")); // >900px
    ...
    // Custom hooks
    const { browser, device, isIOS, isPopular } = useBrowserJsInfo();
